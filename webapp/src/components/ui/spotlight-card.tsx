...
interface GlowCardProps {
  ...
  customSize?: boolean; // Когда true, игнорирует size и использует width/height или className
}
...
const GlowCard: React.FC<GlowCardProps> = ({
  ...
  useEffect(() => {
    // Отслеживаем позицию курсора для эффекта spotlight
  ...
  // CSS для псевдоэлементов эффекта свечения границы
